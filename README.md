...
<body>
    ...
    <div style="white-space: nowrap; overflow-x: auto; padding: 1rem;">
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="bheem characters.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="Bheem.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="chutki.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="indumathi.jpg" style="height: 200px;">
        </div>
    </div>
...
![alt text](image.png)
![alt text](gallery/galleryapp/static/Bheem.jpg)
![alt text](gallery/galleryapp/static/chutki.jpg)
